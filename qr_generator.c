...
static const u8 *ALIGNMENT_PATTERNS[40] = {
	(u8[]){},  /* Empty array for V1 */
	(u8[]){6, 18},
	(u8[]){6, 22},
	(u8[]){6, 26},
	(u8[]){6, 30},
	...
	(u8[]){6, 30, 58, 86, 114},
	(u8[]){6, 34, 62, 90, 118},
	(u8[]){6, 26, 50, 74, 98, 122},
	(u8[]){6, 30, 54, 78, 102, 126},
	(u8[]){6, 26, 52, 78, 104, 130},
	(u8[]){6, 30, 56, 82, 108, 134},
	(u8[]){6, 34, 60, 86, 112, 138},
	(u8[]){6, 30, 58, 86, 114, 142},
	(u8[]){6, 34, 62, 90, 118, 146},
	(u8[]){6, 30, 54, 78, 102, 126, 150},
	(u8[]){6, 24, 50, 76, 102, 128, 154},
	(u8[]){6, 28, 54, 80, 106, 132, 158},
	(u8[]){6, 32, 58, 84, 110, 136, 162},
	(u8[]){6, 26, 54, 82, 110, 138, 166},
	(u8[]){6, 30, 58, 86, 114, 142, 170},
};
